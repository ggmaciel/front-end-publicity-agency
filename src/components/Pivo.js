...
export default function Pivo() {
    ...
    return (
        <div>
            ...
            <div className="pivo-page-image"></div>
            <div className="pivo-page-title">
                <h3>
                    O objetivo dessa campanha foi a divulgação da nova cerveja
                    no mercado brasileiro{" "}
                </h3>
            </div>
            {/*-----------------Instagram section*/}
            <div className="pivo-instagram">
                <img
                    src="/images/instagram-pivo.png"
                    className="instagram-pivo"
                    alt="modelo de celular mostrando o instagram da cerveja"
                />
                <h3>Social media</h3>
            </div>
            {/*-----------------Videos section*/}
            <div className="pivo-videos">
                <img
                    src="/images/videos-pivo.png"
                    className="videos-pivo"
                    alt="dois videos, o primeiro com uma imagem dos barris na fábrica e o segundo com dois homens desfocados e uma cerveja em foco em uma mesa"
                />
                <h3>Audiovisual</h3>
            </div>
