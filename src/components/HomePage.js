...
export default function HomePage() {
    let agencyText = useRef(null);
    let servicesText = useRef(null);
    let logoText = useRef(null);

    useEffect(() => {
        TweenMax.to(agencyText, 1.5, {
            opacity: 1,
            x: 0,
            ease: Power3.easeOut,
        });
        TweenMax.to(servicesText, 1.5, {
            opacity: 1,
            x: 0,
            ease: Power3.easeOut,
        });
        TweenMax.to(logoText, 2.5, {
            opacity: 1,
            y: 0,
            ease: Power3.easeOut,
        });
    ...
    return (
        <div>
            <div className="home-page-top-image">
                <div className="home-page-navbar">
                    ...
                    <ul className="home-page-links">
                        <Scroll to="pivo-link" smooth={true} duration={1000}>
                            <li className="home-page-trabalhos-link">
                                Trabalhos
                            </li>
                        </Scroll>
                        <Scroll
                            to="home-page-contato"
                            smooth={true}
                            duration={1000}
                        >
                            <li className="home-page-contato-link">Contato</li>
                        </Scroll>
                        <Link to="/sobre" className="router-link">
                            <li className="home-page-sobre-link">Sobre</li>
                        </Link>
                    </ul>
                </div>
                <div
                ...
                >
                    <h1 className="home-page-davia">Davia</h1>
                    <h1>&</h1>
                    <h1 className="home-page-brigade">Brigade</h1>
                </div>
            </div>
            <div
                className="home-page-absolute-agencia"
                ref={(el) => {
                    agencyText = el;
                }}
            >
            ...
            {/*-----------------Serviços section*/}
            <div
                className="home-page-serviços-container"
                ref={(el) => {
                    servicesText = el;
                }}
            >
                <div className="home-page-serviços">
                    <h1>SERVIÇOS </h1>
                    <h2>Marketing digital e social media</h2>
                    <h2>Websites</h2>
                    <h2>Campanhas</h2>
                    <h2>Publicidade audiovisual</h2>
                </div>
            </div>
            {/*-----------------Pivo section*/}
            <Link to="/trabalhos/pivo" className="router-link">
                <div className="pivo-link">
                    <div className="pivo-link-text">
                        <h1>PIVO</h1>
                        <h2>PREMIUM LAGER BEER</h2>
                    </div>
                </div>
            </Link>

            {/*-----------------Hawea section*/}
            <Link to="/trabalhos/hawea" className="router-link">
                <div className="hawea-link">
                    <div className="hawea-link-text">
                        <h1>HOTEL HAWEA</h1>
                    </div>
                </div>
            </Link>
            {/*-----------------Virginia section*/}
            <Link to="/trabalhos/virginia" className="router-link">
                <div className="virginia-link">
                    <div className="virginia-link-text">
                        <h1>Virginia</h1>
                    </div>
                </div>
            </Link>
