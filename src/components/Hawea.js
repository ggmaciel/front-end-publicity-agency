...
export default function Hawea() {
    ...
    return (
        <div>
            ...
            <div className="hawea-page-image"></div>
            <div className="hawea-page-title">
                <h3>Rebranding e novo website do Hotel Hawea. </h3>
            </div>
            {/*-----------------Logo and site section*/}
            <div className="hawea-page-logo">
                <img
                    src="/images/hawea-logo.png"
                    className="hawea-logo"
                    alt="logo do hotel hawea"
                />
                <h3>Logo</h3>
            </div>
            <div className="hawea-page-site">
                <img
                    src="/images/hawea-site.png"
                    className="hawea-site"
                    alt="site do hotel hawea"
                />
                <h3>Site</h3>
            </div>
            <div className="hawea-page-site-mobile">
                <img
                    src="/images/hawea-site-mobile.png"
                    className="hawea-site-mobile"
                    alt="site do hotel hawea em um celular"
                />
                <h3>Mobile</h3>
            </div>
